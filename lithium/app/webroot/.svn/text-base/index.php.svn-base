...
/**
echo "Number of queries: " . (integer)\ActiveRecord\ConnectionManager::get_connection()->number_of_queries();
echo "<br/>Page took " . ($endtime - $starttime) * 1000 . " milli-seconds to load.<br/>";

$queries = \ActiveRecord\ConnectionManager::get_connection()->get_queries();
