<?php echo $this->html->link('Back to ' . $score->team->name . '\'s results.', 'teams/view/' . $score->team->id) ?>
        ...
        <table cellpadding="5" cellspacing="0" border="0" width="700">
            ...
            <tr bgcolor="#DCDCDC">
                ...
                <td style="text-align: right;" align="right">
                    <input type="text" name="field_1" size="3" maxlength="3" onchange="calcScore();" value="<?php echo $score->getField("field_1") ?>" disabled="disabled"/>
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: right;">
                    <input type="text" name="field_2" size="3" maxlength="3" onchange="calcScore();" value="<?php echo $score->getField("field_2") ?>" disabled="disabled"/>
                </td>
            </tr>
            <tr bgcolor="#DCDCDC">
                ...
                <td style="text-align: right;">
                    <input type="text" name="field_3" size="3" maxlength="3" onchange="calcScore();" value="<?php echo $score->getField("field_3") ?>" disabled="disabled"/>
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: right;">
                    <input type="text" name="field_4" size="3" maxlength="3" onchange="calcScore();" value="<?php echo $score->getField("field_4") ?>" disabled="disabled"/>
                </td>
            </tr>
