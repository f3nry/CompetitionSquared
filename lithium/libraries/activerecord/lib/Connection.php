...
abstract class Connection
{
	...
	private $logger;
         ...
         */
        static $number_of_queries = 0;

        /**
         * The actual queries that where run.
         */
	...
	public function string_to_datetime($string)
	{
        ...
        /**
         * Returns the number of queries executed through the current connection.
         *
         * @return int The number of queries.
         */
        public static function number_of_queries() {
            return self::$number_of_queries;
        }

        /**
         * Returns the queries executed.
         */
